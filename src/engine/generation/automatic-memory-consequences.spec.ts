      ...
      JSON.stringify({
        memories: [
          ...
          },
          {
            ...
            content: "Mira trusts {{user}} with the key, and {{user}} trusts Mira with the key.",
            confidence: 0.81,
            evidence: "explicit_exchange",
            sourceMessageIds: ["user-1", "assistant-1"],
          },
          ...
          },
          {
            ...
            confidence: 0.93,
            evidence: "explicit_screen_event",
            sourceMessageIds: ["assistant-plot"],
          },
          {
            kind: "contradiction",
        ...
        sourceMessages: [
          {
            ...
            chatId: "chat-1",
            role: "user",
            content: "Miso is my cat, not Mochi. I trust Mira with the key. Please keep this room quiet.",
            characterId: null,
            createdAt: "2026-07-19T10:00:00.000Z",
            speakerLabel: "{{user}}",
          },
          {
            ...
            chatId: "chat-1",
            role: "assistant",
            content: "Mira trusts {{user}} with the key. I promise I'll keep the archive door closed. Mira locked it.",
            characterId: "char-1",
            createdAt: "2026-07-19T10:00:01.000Z",
            speakerLabel: "Mira",
          },
