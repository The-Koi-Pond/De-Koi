      ...
      messages: [
        {
          ...
          content: [
            ...
            "Return only one JSON object with fields name, description, scenario, firstMessage, background, characterIds, rating, and relationshipHistory.",
            ...
            "Write firstMessage as a compact beat brief, not finished prose, using exactly these three labeled lines: Participants: ...; Action: ...; Pressure: .... Keep the complete value at or below 360 characters.",
            "Fill the labels with the concrete participants, immediate action, and pressure the writer should realize. Do not script dialogue, metaphors, similes, editorial asides, or camera-like staging. A brief exact line is allowed only when the user explicitly requested those words, and it still counts toward the 360-character limit.",
            "Honor the requested premise, cast, genre, and opening situation.",
            "For firstMessage specifically: do not explain the scene's theme or force an interruption, reveal, or user choice into the opening beat.",
          ].join("\n"),
        },
        {
          role: "user",
