      ...
      messages: [
        {
          ...
          content: [
            ...
            "Write firstMessage as a compact beat brief, not finished prose: one to three plain sentences and at most 360 characters.",
            "Name the concrete participants, immediate action, and pressure the writer should realize. Do not script dialogue, metaphors, similes, editorial asides, or camera-like staging. A brief exact line is allowed only when the user explicitly requested those words, and it still counts toward the 360-character limit.",
