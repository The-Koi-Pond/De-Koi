...
3. Keep each choice SHORT: 1–2 sentences max. Match the perspective and verb tense already used for the player's messages and actions in the chat. If the chat is written in second person, third person, past tense, or present tense, keep that style; only use first person or a different tense when the chat already uses it.
