...
export const useUIStore = create<UIState>()(
  persist(
    (set, get) => ({
      ...
      setShowMemoryRecallIndicators: (v) => set({ showMemoryRecallIndicators: v }),
      ...
      setUserQuickReplyActions: (actions) => set({ userQuickReplyActions: normalizeUserQuickReplyActions(actions) }),
