...
describe("Deki scene mood", () => {
  ...
  it("uses an explaining pose while Deki is responding", () => {
    ...
    expect(DEKI_SCENE_POSES.responding).toBe("/deki-pond-koi.svg");
  });
});
