...
function CoreModulesSettings() {
  ...
  const handleToggle = async (moduleId: string, enabled: boolean, name: string) => {
    try {
      ...
      toast.error(toUserMessage(error, "coreModuleToggle"));
    }
  };
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="flex flex-col gap-2">
        ...
        {!isLoading && isError && (
          <QueryErrorState
            title="Core modules unavailable"
            message={toUserMessage(error, "coreModuleLoad")}
            ...
            >
              ...
              <div className="mt-3 grid gap-2 text-xs sm:grid-cols-2">
                ...
                <div>
                  ...
                  <div className="mt-0.5 truncate font-mono text-[0.6875rem] text-[var(--foreground)]">
                    {module.main}
                  </div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="mt-0.5 text-[var(--foreground)]">
                    {module.runtime ??
                      (module.surfaces === 1 ? "1 surface" : module.surfaces ? `${module.surfaces} surfaces` : "None")}
                  </div>
                </div>
                <div>
