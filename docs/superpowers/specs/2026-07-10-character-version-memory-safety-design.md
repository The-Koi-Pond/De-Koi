...
9. Failed attempts retain content-addressed assets because another concurrent record may already reference the same file; successful startup later removes only unreferenced files matching the version-content-address naming contract.
