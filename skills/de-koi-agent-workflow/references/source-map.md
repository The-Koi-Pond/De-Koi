...
- `reference/FULL_WORKFLOW_REFERENCE.md` -> `SKILL.md`, `references/de-koi-overrides.md`, `references/proof-templates.md`, and the workflow/template files.
...
- `scripts/check-workflow-pack.ps1` and `scripts/make-zip.ps1`: package validation/export scripts for the external workflow pack, not useful for De-Koi agent behavior.
...
- Current workflow target: `The-Koi-Pond/De-Koi`, branch `main`.
