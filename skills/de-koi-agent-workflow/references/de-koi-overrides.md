# De-Koi Overrides For Workflow Pack Assumptions
...
Before filing a feature request, check whether existing De-Koi features, settings, docs, prompts, lorebooks, or workflows already cover the requested outcome. If they do, explain the existing path and do not file unless the user explicitly says to file anyway.
