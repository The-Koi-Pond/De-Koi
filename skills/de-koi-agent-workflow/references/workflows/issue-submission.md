...
For feature requests, check whether existing De-Koi features, settings, docs, prompts, lorebooks, or workflows already cover the requested outcome. If an existing path only partially covers it, explain the gap and file only the missing capability.
