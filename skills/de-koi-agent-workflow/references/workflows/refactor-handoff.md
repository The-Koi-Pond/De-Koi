...
Use this for refactor, cleanup, architecture, and modernization work. It is not a replacement for `AGENTS.md`, `de-koi-architecture-guard`, or `de-koi-mode-separation`.
