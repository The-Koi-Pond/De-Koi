...
For new implementation work on De-Koi, start from current `origin/main` on a fresh topic branch unless the user explicitly says to continue the current branch.
