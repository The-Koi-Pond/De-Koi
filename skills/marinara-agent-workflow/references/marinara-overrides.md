...
The source pack has Marinara assumptions about legacy `staging` and team-branch workflow. This checkout is `The-Koi-Pond/De-Koi` on the `main` branch unless the current task says otherwise.
