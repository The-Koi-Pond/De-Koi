...
For new implementation work on the refactor code line, start from current `origin/main` on a fresh De-Koi topic branch unless the user explicitly says to continue the current branch.
