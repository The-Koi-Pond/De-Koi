...
- `workflow-health.mjs` is for nontrivial work, PR work, issue selection, and risky workflow changes. It is not mandatory for a tiny one-file local bug unless repo policy or visible risk requires it.
